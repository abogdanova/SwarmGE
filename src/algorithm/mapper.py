...
def mapper(genome, tree):
    ...
    if tree and (not used_codons or invalid is None or (not phenotype and not
                 invalid) or not depth or not nodes):
        # input, output, invalid, depth, and nodes can all be generated by
        # recursing through the tree once.
        
        input, output, invalid, depth, \
