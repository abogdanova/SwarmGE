def help_message():
    lines = ["Welcome to PonyGE - Help",
             ...
             "\t--max_init_depth: \t\tSets the max tree depth for initialisation",
             "\t--genome_init: \t\tWill initialise individuals by generating a random genome for each individual",
             ...
             "\t--mutation_probability: \t\tSets the rate of mutation probability for linear genomes",
             "\t--mutation_events: \t\tSets the number of mutation events based on probability",
             ...
             "\t--lookup_fitness: \t\tUses the cache to lookup duplicate fitnesses. Automatically set to true with cache turned on.",
             "\t--lookup_bad_fitness: \t\tGives duplicate phenotypes a bad fintness when encountered, requires cache.",
             "\t--mutate_duplicates: \t\tReplaces duplicate idividuals with mutated versions. Requires cache.",
